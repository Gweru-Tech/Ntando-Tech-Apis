document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Ladybug🐞 UI");
        setContent('header', 'textContent', settings.name || "Ladybug🐞 UI");
        setContent('name', 'textContent', settings.name || "Ladybug🐞 UI");
        setContent('version', 'textContent', settings.version || "v0.0 Beta");
        setContent('versionHeader', 'textContent', settings.header.status || "Online!");
        setContent('description', 'textContent', settings.description || "Ladybug🐞 API's Premium 🔰");
